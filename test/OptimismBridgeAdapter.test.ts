 ...
 * 
 * Tests Optimism L2 integration including:
 ...
 * - Security controls
 */
describe("OptimismBridgeAdapter", function () {
    // Role constants
    ...
    describe("State Sync", function () {
        ...
        it("Should receive state from L1", async function () {
            ...
            const blockNumber = await adapter.read.getStateRootBlock([testStateRoot]);
